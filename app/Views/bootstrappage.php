...
<html lang="en">
    <head>
        ...
        <title>Praktek CodeIgniter 4</title>
        ...
        <script>
            WebFont.load({
                google: {"families":["Latto:300,400,700,900"]},
                custom: {"families":[
    ...
    <body>
        <p style="width: 100%; text-align: center; margin-top: 50px;">
            <button type="button" class="btn btn-secondary btn-lg">Tombol Percobaan</button>
        </p>
        <div class="col-md-6 ml-auto mr-auto">
            <div class="card">
                <div class="card-header"><h4 class="card-title">Percobaan Panel</h4></div>
                <div class="card-body">
                    <ul class="nav nav-pills nav-secondary nav-pills-no-bd" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="pill" href="#tab1" role="tab">Tomorrow War</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="pill" href="#tab2" role="tab">Greyhound</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="pill" href="#tab3" role="tab">Army Of Thieves</a>
                        </li>
                    </ul>
                    <div class="tab-content mt-2 mb-2">
                        ...
                        <div class="tab-pane fade show active" id="tab2" role="tabpanel">
                            <p  style="color: green">Several months after the U.S. entry into world war II, an inexperienced U.S. Navy commander must lead an allied convoy being stalked by a German submarine wolf pack</p>
                        </div>
                        <div class="tab-pane fade" id="tab3" role="tabpanel">
                            <p  style="color: blue">A prequel, set before the event of army of the dead, which focuses on German safecracker ludwig dieter leadeng a group of aspiring thieves on a top scret heist during the early stages of the zombie apocalypse</p>
                        </div>
                    </div>
                </div>
            </div>
